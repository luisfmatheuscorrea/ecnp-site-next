...
export function Investiment() {
  ...
  function goToReceive() {
    window.open('https://api.whatsapp.com/send?1=pt_br&phone=5524999134517&text="Olá, vim pelo site e estou interessado no curso e queria receber a aula gratuita!"', 'blank')
  }
  ...
  return (
    <>
      <Section className='investiment'>
        <div className="box">
          <TitlesSections data-aos="zoom-out-right" data-aos-delay="100">E o que <strong>terei</strong><br/> no curso?</TitlesSections>
          <div className="grid">
          ...
          <div className="or-text" data-aos="zoom-out-right" data-aos-delay="100">ou</div>
          <Button color={colors.secondary} margin="1rem 0 0 0 !important" data-aos="zoom-out-right" data-aos-delay="250" extended onClick={goToSubscription}>Receber uma aula gratuita</Button>
        </div>
